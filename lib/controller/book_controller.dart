...
class BookController extends GetxController {
  ...
  void updateBook() {
    if (booktoUpdate != null) {
      if (bookNameController.text.isNotEmpty ||
        ...
        var updatedBook = booktoUpdate!.copyWith(
            bookName: bookNameController.text,
            bookPrice: bookPriceController.text,
            bookDescription: bookDescriptionController.text,
            bookAuthor: bookAuthorController.text,
        ...
        booktoUpdate!.copyWith(
            ...
            bookPrice: booktoUpdate!.bookPrice,
            bookDescription: booktoUpdate!.bookDescription,
            bookAuthor: booktoUpdate!.bookAuthor,
           
           );
        listOfBooks[indexToupdate] = booktoUpdate!;
  ...
  void changeColumnName() async {
_dataBaseService.changeColumnNamebookAuthorTobookWriter();
